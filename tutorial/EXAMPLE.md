# Olá, eu sou Maria Silva! 👋

> Este é um arquivo de **exemplo**. Crie o seu próprio na pasta `community/` com o nome do seu usuário do GitHub!

---

## Sobre mim

- 🎮 Aluna da Ctrl+Play Young
- 💻 Aprendendo: Git, GitHub e Python
- 🚀 Estou na Ctrl+Play porque: Quero aprender Python para fazer sites
- ⚡ Fun fact: Não consigo passar um dia sem jogar alguma coisa!
- Eu 💙 : comida
